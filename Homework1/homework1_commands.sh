...
terraform plan -var=aws_access_key="YOUR_ACCESS_KEY" -var=aws_secret_key="YOUR_SECRET_KEY" -out homework1.tfplan
...
terraform plan -out homework1.tfplan
terraform apply "homework1.tfplan"
